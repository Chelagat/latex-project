...
print(findFiles('/Users/norahborus/Desktop/data/names/*.txt'))
...
#print ("Here")
for filename in findFiles('/Users/norahborus/Desktop/data/names/*.txt'):
  #  print("*********" + filename)
...
class RNN(nn.Module):
    ...
    def initHidden(self):
        return Variable(torch.zeros(224, 224))


n_hidden = 224
rnn = RNN(224, 224, n_categories)
...
hidden = Variable(torch.zeros(224, 224))
...
def train(category_tensor, line_tensor):
    ...
    for i in range(line_tensor.size()[0]):
        print("****INPut*****", line_tensor.size())
        output, hidden = rnn(line_tensor[i], hidden)

    print ("OUTPUT: ", output)
    print ("Category tensor ",category_tensor)
